/*
* Author: Diego Lara  Due Date: 12/3/16   Name: Project 5ec
*
...
void testBinarysearchtree()
{
    ...
    while(winsert=="y")
    {
        ...
        english.insert(userinsert, &english.update);
    ...
    std::string wprint;
    std::cout<<"If you want to traverse the binary search tree enter y"<<std::endl;
    std::cin >> wprint;
    while(wprint=="y")
    {
    ...
    std::cout << "Now to print the function with the print function"<< std::endl;
    english.print();
